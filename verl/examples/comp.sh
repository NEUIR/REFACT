...
pip install /backup/user/xuxiaoyue/verl_tools/block_sparse_attn-0.0.1-cp310-cp310-linux_x86_64.whl
pip install /backup/user/xuxiaoyue/verl_tools/nsa-0.0.0-cp310-cp310-linux_x86_64.whl
...
pip install /backup/user/xuxiaoyue/verl_tools/omegaconf-2.4.0.dev3-py3-none-any.whl
pip install /backup/user/xuxiaoyue/verl_tools/hydra_core-1.4.0.dev1-py3-none-any.whl
pip install grpcio grpcio-tools protobuf loguru
pip install tokenizers==0.21.0
pip install swanlab
pip install transformers -U
pip list | grep transformers
rm -rf /root/.cache/huggingface/modules/transformers_modules/job_47031_iter_600
cp ./modeling_minicpm.py /root/.cache/huggingface/modules/transformers_modules/job_47031_iter_600/modeling_minicpm.py
