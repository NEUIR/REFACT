...
class NaiveRewardManager:
    ...
    def __init__(self, tokenizer, num_examine, compute_score=None, reward_fn_key="data_source", enable_loop_detection=False, **kwargs) -> None:
    ...
    def __call__(self, data: DataProto, return_dict=False):
        ...
        for i in range(len(data)):
            ...
            if isinstance(score, dict):
                ...
                reward = score
            # Always record the ground-truth answer alongside predictions and scores
