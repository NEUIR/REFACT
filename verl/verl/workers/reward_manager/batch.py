...
class BatchRewardManager:
    def __init__(self, tokenizer, num_examine, compute_score, reward_fn_key="data_source", **reward_kwargs):
        ...
        self.enable_loop_detection = reward_kwargs.pop("enable_loop_detection", False)
        self.loop_detection_threshold = reward_kwargs.pop("loop_detection_threshold", 3)
    ...
    def __call__(self, data: DataProto, return_dict=False):
        ...
        scores, responses_str = self.verify(data)
        rewards = []
        already_printed = {}
        ...
        for i in range(len(data)):
            ...
            if isinstance(score, dict):
                ...
                reward = score
            # Record ground-truth answer for this sample
            gt = data[i].non_tensor_batch["reward_model"].get("ground_truth", None)
            reward_extra_info["answer"].append(gt)
